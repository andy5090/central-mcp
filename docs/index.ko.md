...
<p class="cmcp-hero-sub">Claude Code · Codex · Gemini · opencode를 모든 프로젝트에 한꺼번에 풀어두세요. 컨텍스트 스위칭은 central-mcp가 대신 — 토큰은 <span class="cmcp-hero-counter" data-min="10" data-max="100">10×</span>까지, 집중력은 그대로.</p>
