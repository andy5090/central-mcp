...
This picks your preferred orchestrator (claude / codex / gemini / opencode / hermes / openclaw / gjc), launches it, and exposes central-mcp's MCP tools to it. Everything from here happens in natural language inside that session.
